...
**Directory:** `/path/to/software/trace/workflow/scripts/`
...
**Directory:** `/path/to/software/trace/workflow/`
...
```bash
cd /path/to/projects/HEK293/2025_HEK293_LGC_reporter
